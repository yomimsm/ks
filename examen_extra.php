...
<body>
   <form action="evaluacion_extra.php" method="POST">
    ...
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white;">1.-¿MENCIONA 5 REGLAS DE SEGURIDAD DE LA COMPAÑÍA? </h3>
    <br>
    ...
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white;">      2.- ¿A QUÉ SE COMPROMETE LA EMPRESA AL CERTIFICARSE EN LA NORMA ISO 14001-2015 ? </h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white;">
        ...
        <div style="float: right;width: 400px;color:white;">  <input type="checkbox" name="incorrecta3" id="incorrecta3" value = "2">B) Al cuidado del agua y luz.</div>
    </div>
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">       3.- ¿QUÉ ES UN ACTO INSEGURO?</h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white;">
       ...
       <div style="float: right;width:400px;color:white;"> <input type="checkbox" name="incorrecta1" id="incorrecta1" value = "2"> B) Sucede cuando el personal no quiere realizar su trabajo</div>
    </div>
    <br><br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">      4.-MENCIONA 3 REGLAS A SEGUIR EN CASO DE UNA EMERGENCIA? </h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
       <textarea name="emergencia" id="emergencia" cols="67" rows="5"style="resize: both;"></textarea>
    </div>
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">      5.- ¿QUÉ  ES UNA CONDICIÓN INSEGURA?</h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
    ...
    <br><br><br><br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">      6.- ¿DE LAS SIGUIENTES IMÁGENES ENCIERRA EL INCISO QUE CORRESPONDE A LA CORRECTA IDENTIFICACIÓN SEGÚN EL SISTEMA GHS? </h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
        <div style="float:left; width:500px;color:white" ><input type="checkbox" name="incorrecta7" id="incorrecta7" value = "1">A) <br><br><img src="img/autotipo.png" alt="" style="width: 80%;"><img src="img/manos1.png" alt="">
    </div>
    &nbsp;&nbsp;&nbsp;
    <div style="float: right;width:400px;color:white;"><input type="checkbox" name="correcta7" id="correcta7" value = "2">B) <br><br><img src="img/cloro.png" alt="" style="width: 100%;"><img src="img/mono2.png" alt=""></div>
    </div>
    ...
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
       <div style="float:left; width:500px:color:white" > <input type="checkbox" name="incorrecta4" id="incorrecta4" value = "1">A) Porque de forma voluntaria  deben cuidar el medio ambiente. </div>
        &nbsp;&nbsp;&nbsp;
       <div style="float: right;width:400px;color:white;"><input type="checkbox" name="correcta4" id="correcta4" value = "2">B) Por los impactos ambientales que pueden generar a causas de sus actividades.</div>
    </div>
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">      8.-¿QUÉ ES UN RIESGO LABORAL?</h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
        ...
        &nbsp;&nbsp;&nbsp;
        <div style="float: right;width:400px;color:white;"><input type="checkbox" name="correcta2" id="correcta2" value = "2"> B) Es aquel que  sucede a  consecuencias del trabajo que estas  realizando</div>
    </div>
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">        9.- ¿PARA QUÉ NOS SIRVE EL SISTEMA GLOBAL ARMONIZADO GHS?  </h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
        ...
        &nbsp;&nbsp;&nbsp;
        <div style="float: right;width: 400px"> <input type="checkbox" name="correcta5" id="correcta5" value = "2">B) Para  la identificación y  comunicación de los riesgos y peligros  de una sustancia química.</div>
    </div>
    <br>
    <h3 style="margin-left:50px; font-family: play-Bold;color:white">         10.- ¿QUÉ ES UN PICTOGRAMA?   </h3>
    <br>
    <div style="margin-left:50px; font-family: play-Bold;color:white">
    ...
    &nbsp;&nbsp;&nbsp;
    <div style="float: right;width: 400px;color:white"><input type="checkbox" name="incorrecta6" id="incorrecta6" value = "2">B)  Es un  rombo de seguridad que utiliza 4 colores amarillo, azul, rojo y blanco y en cada uno de ellos enumera los riesgos de la sustancia química , dependiendo el color es el riesgo al que se especifica.</div>
    </div>
    <br><br><br><br><br><br><br><br>
    <br>
